                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <div id="datewise" class="collapse" style="margin: 10px 15px">
                                    <form method="POST" action="datewise_credit_ledger.jsp" class="form-inline">
                ...
                <table  border="2" width="100%" class="table-striped table-responsive">
                    <thead>
                        <tr style="background-color: #CCC">
                            ...
                            <th style="text-align: center">Credit Name</th>
                    ...
                    <tbody>
                        <%
                            ...
                            Accountant acc=ap.TotalCredit();
                            List<Accountant> list = ap.MonthlyCreditLedger();
                            for (Accountant ac : list) {
                        %>
                        <tr>
                            <td style="text-align: center"></td>
                            <td style="text-align: center"><%= ac.getCreditdate()%></td>
                            <td style="text-align: center"><%= ac.getCreditname()%></td>
                            <td style="text-align: center"><%= ac.getCreditamount()%></td>
                        </tr>
                        <% }%>
                        <tr style="background-color: #CCC">
                            ...
                            <th style="text-align: center"><%= acc.getTotalcredit() %></th>
                        </tr>
