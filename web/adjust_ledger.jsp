...
<html class="no-js" lang="">
    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        %>
            ...
            String query = "select RETAILER, NOTE, AMOUNT, DATE from adjustment where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE())";
