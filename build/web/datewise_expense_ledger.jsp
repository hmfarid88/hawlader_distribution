        ...
        %>
            <%
                ...
                try {
                    ...
                    String query = "select COST_NAME, NOTE, AMOUNT, DATE from cost where DATE between '" + date1 + "' and '" + date2 + "'";
                    ps = con.prepareStatement(query);
                    rs = ps.executeQuery();
                    String query1 = "select sum(AMOUNT) from cost where DATE between '" + date1 + "' and '" + date2 + "'";
                    ps = con.prepareStatement(query1);
                    rs1 = ps.executeQuery();
                    rs1.next();
                    request.setAttribute("total", rs1.getDouble(1));
            %>
