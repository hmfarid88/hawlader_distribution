...
<html class="no-js" lang="">
    ...
    <br> <center><h3> You are not logged in</h3><br/>
        ...
        %>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li>
                                    <div id="datewise" class="collapse" style="margin: 10px 15px">
                                        <form method="POST" action="datewise_additional_discount.jsp" class="form-inline">
            ...
            String query = "select RETAILER, INVOICENO, NOTE, AMOUNT, DATE from additionaldis where YEAR(DATE) = YEAR(CURRENT_DATE()) AND MONTH(DATE) = MONTH(CURRENT_DATE())";
