            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav">
                    ...
                    <li> <a href="accountant.jsp"><span class="fa fa-home"></span> Home</a></li>
                     <li> <a href="order_create.jsp"><span class="fa fa-window-restore"></span> More Order</a></li>                  
                </ul>
                                ...
                                <tr style=" border-bottom-style: hidden">
                                    <td style="border-right-style: hidden; font-size: 12px" width="50%">
                                        <%
                                            ...
                                            try {
                                                con = Database.getConnection();
                                                String query = "select SR_NAME, DATE  from order_list where SR_NAME='"+srname+"' and DATE=CURDATE()";
                                                ps = con.prepareStatement(query);
                                                rs = ps.executeQuery();
                                                while (rs.next()) {
                            ...
                            <table id="dist" border="1" width="100%" class="myTables"  cellspace="1px" >
                                ...
                                <tbody>
                                    ...
                                    <%
                                        try {
                                            con = Database.getConnection();
                                            String query = "select PRODUCT_ID, MODEL, COLOR, PRICE from order_list where  SR_NAME='"+srname+"' and DATE=CURDATE()";
                                            ps = con.prepareStatement(query);
                                            rs = ps.executeQuery();
                                            while (rs.next()) {
